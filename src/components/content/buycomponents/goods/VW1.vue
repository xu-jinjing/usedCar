<template>
  <div class="VW1">
    <div class="top">
      <div class="top-left">
        <vw1-swiper></vw1-swiper>
      </div>
      <div class="top-right">
        <img src="../../../../assets/img/goodsimg/VW//VW1img/top-right.png" alt="">
        <button id="btn1" @click="btn1Click()">我要预约</button>
        <button id="btn2" @click="btn2Click()">免费咨询</button>
    ...
    <div class="bottom">
      <h1>大众 朗逸 2011款 1.4TSI DSG品轩版 基本信息</h1>
