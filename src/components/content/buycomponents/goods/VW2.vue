<template>
  <div class="VW1">
    <div class="top">
      <div class="top-left">
        <vw2-swiper></vw2-swiper>
      </div>
      <div class="top-right">
        <img src="../../../../assets/img/goodsimg/VW//VW2img/top-right.png" alt="">
        <img src="../../../../assets/img/goodsimg/VW//VW2img/right-bottom.png" alt="">
    ...
    <div class="center">
      <img src="../../../../assets/img/goodsimg/center.png" alt="">
    </div>

    <div class="bottom">
      <h1>大众 朗行 2013款 1.6L 自动舒适型 基本信息</h1>
...
<script>
  ...
  import Vw2Swiper from '../goods/goodSwiper/VW2swiper'
  import VwAblum2 from '@/components/content/buycomponents/goods/goodsAlbum/VwAblum2'
...
<style scoped>
  .top{
    width: 100%;
    height: 520px;
    background-color: rgba(248, 239, 239, 0.637);
  }
  .top-left{
    width: 700px;
    height: 520px;
